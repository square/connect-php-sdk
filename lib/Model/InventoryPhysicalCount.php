...
class InventoryPhysicalCount implements ArrayAccess
{
    ...
    /**
     * Sets id
     * @param string $id A unique ID generated by Square for the `InventoryPhysicalCount`.
     * @return $this
     */
    ...
    /**
     * Sets reference_id
     * @param string $reference_id An optional ID provided by the application to tie the `InventoryPhysicalCount` to an external system.
     * @return $this
     */
    ...
    /**
     * Sets employee_id
     * @param string $employee_id The Square ID of the `Employee` responsible for the physical count.
     * @return $this
     */

...
class CatalogObjectBatch implements ArrayAccess
{
    ...
    /**
      * $objects A list of `CatalogObject`s belonging to this batch.
    ...
    /**
     * Sets objects
     * @param \SquareConnect\Model\CatalogObject[] $objects A list of `CatalogObject`s belonging to this batch.
     * @return $this
     */

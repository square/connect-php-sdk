...
class CreateCustomerCardRequest implements ArrayAccess
{
    ...
    /**
      * $card_nonce A card nonce representing the card data to link to the customer.
      * @var string
      */
    protected $card_nonce;
    
    /**
      * $billing_address Postal code in the address is required for US and Canada payments.

...
class InventoryTransfer implements ArrayAccess
{
    ...
    /**
      * $state The `InventoryState` for the quantity of items being transfered. See [InventoryState](#type-inventorystate) for possible values
      * @var string
      */
    protected $state;
    /**
    ...
    /**
     * Sets id
     * @param string $id A unique ID generated by Square for the `InventoryTransfer`.
     * @return $this
     */
    ...
    /**
     * Sets reference_id
     * @param string $reference_id An optional ID provided by the application to tie the `InventoryTransfer` to an external system.
     * @return $this
     */
    ...
    /**
     * Sets state
     * @param string $state The `InventoryState` for the quantity of items being transfered. See [InventoryState](#type-inventorystate) for possible values
     * @return $this
     */
     ...
     * @param string $from_location_id The Square ID of the `Location` where the related quantity of items were tracked before the transfer.
     * @return $this
     */
    ...
    /**
     * Sets to_location_id
     * @param string $to_location_id The Square ID of the `Location` where the related quantity of items were tracked after the transfer.
     * @return $this
     */
    ...
    /**
     * Sets employee_id
     * @param string $employee_id The Square ID of the `Employee` responsible for the inventory transfer.
     * @return $this
     */

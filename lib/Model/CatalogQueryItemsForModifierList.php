...
class CatalogQueryItemsForModifierList implements ArrayAccess
{
    ...
    /**
      * $modifier_list_ids A set of `CatalogModifierList](#type-catalogmodifierlist) IDs to be used to find associated [CatalogItem`s.
      * @var string[]
      */
     ...
     * @param string[] $modifier_list_ids A set of `CatalogModifierList](#type-catalogmodifierlist) IDs to be used to find associated [CatalogItem`s.
     * @return $this
     */

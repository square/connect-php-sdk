...
class CatalogQuerySortedAttribute implements ArrayAccess
{
    ...
    /**
      * $sort_order The desired `SortOrder`. See [SortOrder](#type-sortorder) for possible values
      * @var string
      */
    ...
    /**
     * Sets sort_order
     * @param string $sort_order The desired `SortOrder`. See [SortOrder](#type-sortorder) for possible values
     * @return $this
     */

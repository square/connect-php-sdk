...
class ListCustomersRequest implements ArrayAccess
{
    ...
    /**
     * Sets sort_field
     * @param string $sort_field Indicates how Customers should be sorted. Default: `DEFAULT`.
     * @return $this
     */
    ...
    /**
     * Sets sort_order
     * @param string $sort_order Indicates whether Customers should be sorted in ascending (`ASC`) or descending (`DESC`) order. Default: `ASC`.
     * @return $this
     */

...
class CatalogQueryItemsForTax implements ArrayAccess
{
    ...
    /**
      * $tax_ids A set of `CatalogTax](#type-catalogtax) IDs to be used to find associated [CatalogItem`s.
      * @var string[]
      */
    protected $tax_ids;
    ...
    /**
     * Sets tax_ids
     * @param string[] $tax_ids A set of `CatalogTax](#type-catalogtax) IDs to be used to find associated [CatalogItem`s.
     * @return $this
     */

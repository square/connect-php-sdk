...
class MerchantsApi
{
     ...
     * ListMerchants
     *
     * @param int $cursor The cursor generated by the previous response. (optional)
     * @return \SquareConnect\Model\ListMerchantsResponse
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listMerchants($cursor = null)
    {
        list($response, $statusCode, $httpHeader) = $this->listMerchantsWithHttpInfo ($cursor);
        return $response; 
    }
     ...
     * @throws \SquareConnect\ApiException on non-2xx response
     */
    public function listMerchantsWithHttpInfo($cursor = null)
    {
